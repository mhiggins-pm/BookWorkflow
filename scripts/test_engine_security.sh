#!/bin/bash
#
# test_engine_security
#
# This script sends a ReadyAPI SECURITY Test Suite to a TestEngine server and
...
RELEASE="v1.0.0"
echo " "
echo "test_engine_security  ${RELEASE} - `date`"
echo " "
...
then
   ...
   echo " "
   echo "usage: ./test_engine_security.sh <te-user> <te-password> <rapi-project>"
   echo " "
   exit 1
fi
...
echo "Security suite in: $TEST_SUITE"
echo " "
