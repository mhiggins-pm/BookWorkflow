...
const PUBLISH_URL = `https://52.16.125.35/apis/${owner}/${api}/${version}/settings/lifecycle?force=false`;
const MARK_DEFAULT_URL = `https://52.16.125.35/apis/${owner}/${api}/settings/default`;
